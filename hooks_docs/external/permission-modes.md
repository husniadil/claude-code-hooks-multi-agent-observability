...
# permission-modes — hooks-relevant excerpts

> 📄 Full page: https://code.claude.com/docs/en/permission-modes.md

> Kept: full plan and auto mode sections (modes hooks set/respect, PermissionDenied/retry, classifier vs allow/deny rules, protected paths), available-modes table, defaultMode settings, and the Hooks See-also link to PreToolUse/PermissionRequest.
