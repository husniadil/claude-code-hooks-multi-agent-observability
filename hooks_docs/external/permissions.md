...
# permissions — hooks-relevant excerpts

> 📄 Full page: https://code.claude.com/docs/en/permissions.md

> Kept: Manage permissions, permission modes, full rule syntax (reused by the hook `if` field), how PreToolUse allow/deny/ask interacts with permission rules and managed deny lists, disableBypassPermissionsMode, managed settings, and settings precedence (deny > hook allow).
...
## Working directories (hook loading note)
